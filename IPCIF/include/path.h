...
DLLAPI(int) get_absolute_path_v(const string& cur_dir, const string& relative_path, path_cache& array_absolute_path, int (*is_absolute_path)(char* path, char dsym), char dsym=_dir_symbol, path_cache_type type=PCT_C_STYLE);
