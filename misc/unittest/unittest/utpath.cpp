...
void merge_path(string& path, const vector<string>& split, char dsym)
{
	path.clear();
...
int get_absolute_path(const string& cur_dir, const string& relative_path, string& absolute_path, int (*is_absolute_path)(char* path, char dsym), char dsym)
{
	int ret=0;
...
void concat_path(const string& path1, const string& path2, string& merge, char dsym)
{
