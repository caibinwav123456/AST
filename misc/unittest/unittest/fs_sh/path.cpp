...
DLLAPI(void) split_path(const string& path, path_cache& split, char dsym)
{
	split.clear();
	int pos=0;
	int nextpos=0;
...
DLLAPI(void) merge_path(string& path, const path_cache& split, char dsym)
{
	path.clear();
...
DLLAPI(void) concat_path(const string& path1, const string& path2, string& merge, char dsym, path_cache_type type)
{
